...
const Fixture = ({ fixture, showLeaguePronos, setShowLeaguePronos, errorProno, savingAll }) => {
  ...
  const { showLeagues, setShowLeagues, seeLeaguePronos } = useShowLeaguesPronos(
    showLeaguePronos,
    setShowLeaguePronos
  );
    ...
    <div className="fixture-line">
      <table>
        ...
        <tbody>
          ...
          {errorProno ? (
            <ErrorMessage style={{ marginTop: 20 }}>{errorProno}</ErrorMessage>
          ) : (
      ...
      {pronogeek.points > 0 && pronogeek.bonusFavTeam && (
        <div className="points-cell">
          ...
          <br />
          avec bonus {pronogeek.exact && 'score exact (cote*2)'}
          {pronogeek.exact && <br />}
      ...
      {pronogeek.points > 0 && !pronogeek.bonusFavTeam && (
        <div className="points-cell">
          Tu as scoré {pronogeek.points}pts{pronogeek.exact && ','}
          {pronogeek.exact && <br />}
      ...
      {pronogeek.points === 0 && pronogeek.addedToProfile && (
        <div className="points-cell">Dommage, mauvais prono...</div>
      )}
