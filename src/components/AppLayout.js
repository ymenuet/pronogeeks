                    ...
                    <ul className="navbar-nav mt-2 mt-lg-0">
                        {user ? (
                            <>
                                ...
                                <li className="nav-item">
                                    <Link className="nav-link" to="/profile"><svg width="1.6em" height="1.6em" viewBox="0 0 16 16" className="bi bi-house-fill my-home-icon" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
