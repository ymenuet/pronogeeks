...
export const getLeague = (leagueID) => async (dispatch, getState) => {
  ...
  try {
    ...
    errorLeague[leagueID].error = printError(
      'fr',
      error,
      `Erreur lors du chargement de la ligue. Recharge la page ou réessaye plus tard.`
    );
...
export const getUserLeagues = () => async (dispatch, getState) => {
  ...
  try {
    ...
    errorLeagues.error = printError(
      'fr',
      error,
      `Erreur lors du chargement des ligues. Recharge la page ou réessaye plus tard.`
    );
...
export const editLeague =
  ...
  async (dispatch, getState) => {
    ...
    try {
      ...
      const editedLeague = copyReducer(
        getState,
      ...
      dispatch({
        ...
        payload: printError(
          'fr',
          error,
          `Erreur lors de la sauvegarde de la ligue. Essaye encore.`
        ),
      });
    }
  };
