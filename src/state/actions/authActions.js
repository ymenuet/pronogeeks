...
const baseURL =
  process.env.NODE_ENV === 'production' ? `/auth` : `${process.env.REACT_APP_BACKENDPOINT}/auth`;
  ...
  try {
    ...
    dispatch({
      ...
      payload: printError(
        'fr',
        error,
        `Problème lors de la connexion au server. Recharge la page ou réessaye plus tard.`
      ),
    });
  }
};
  ...
  try {
    ...
    dispatch({
      ...
      payload: printError(
        'fr',
        error,
        'Il y a eu une erreur lors de la confirmation de ton email. Merci de réessayer.'
      ),
    });
  }
};
  ...
  try {
    ...
    dispatch({
      ...
      payload: printError(
        'fr',
        error,
        'Erreur lors de la mise à jour du pseudo. Réessaye plus tard.'
      ),
    });
  }
};
  ...
  try {
    ...
    dispatch({
      ...
      payload: printError(
        'fr',
        error,
        'Erreur lors de la mise à jour de la photo de profil. Réessaye plus tard.'
      ),
    });
  }
};
  ...
  try {
    ...
    dispatch({
      ...
      payload: printError(
        'fr',
        error,
        `Erreur lors de l'envoi du lien d'actualisation. Réessaye plus tard.`
      ),
    });
  }
};
  ...
  try {
    ...
    dispatch({
      ...
      payload: printError(
        'fr',
        error,
        `Erreur lors de l'actualisation du mot de passe. Réessaye plus tard.`
      ),
    });
  }
};
  ...
  try {
    ...
    dispatch({
      ...
      payload: printError(
        'fr',
        error,
        `Erreur lors de la suppression du compte. Réessaye plus tard.`
      ),
    });
  }
};
