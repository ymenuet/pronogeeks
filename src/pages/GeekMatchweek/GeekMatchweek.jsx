...
import { useSeason, useMatchweekFixtures, useGeekInfo, useGeekMatchweekPronos, useGeekMatchweekPoints } from '../../utils/hooks'
import './pronogeeks.css'

const GeekMatchweek = ({ match: { params: { matchweekNumber, seasonID, geekID } }, history, loading }) => {
    ...
    const { matchweekPoints, matchweekBonus, matchweekCorrects, noPronogeeks } = useGeekMatchweekPoints(geek, seasonID, matchweekNumber)
