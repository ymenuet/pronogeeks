                ...
                <div className='col-10 offset-1 col-md-8 offset-md-2'>
                    ...
                    <div className='home-div' style={{ width: '100%' }}>
                        ...
                        <div className='home-message rules-privacy-policy' style={{ width: '100%' }}>
                            ...
                            <section className='relative-links' id='link-to-pronogeeks'></section>
                            ...
                            <section className='relative-links' id='link-to-provisional-ranking'></section>
                            <section id='rules-provisional-ranking'>
                                ...
                                <p className='no-margin-para'>Les points apportés par le classement prévisionnel sont calculés et ajoutés au total de la saison une fois cette dernière terminée, sous le modèle suivant :</p>
                                ...
                                <p className='no-margin-para'>Un système de bonus combo s'applique de la manière suivante, en fonction du nombre de clubs bien situés dans le classement prévisionnel :</p>
                                ...
                                <p className='no-margin-para'>Pour résumer et donner un exemple, il y a potentiellement 2700pts bonus à prendre en fin de saison sur le classement prévsionnel, en cas de perfect !</p>
                            ...
                            <section className='relative-links' id='link-to-ranking'></section>
