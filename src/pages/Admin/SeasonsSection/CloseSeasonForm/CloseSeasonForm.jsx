...
import { closeSeason, targetedResetSeasons } from '../../../../state/actions/seasonActions';
...
const CloseSeasonForm = () => {
  ...
  const { seasonClosed, loading } = useSelector(({ seasonReducer }) => seasonReducer);
  ...
  return (
    <>
      ...
      <Modal
        ...
        body={t('admin.seasons.closeSeason.modal.body', {
          season: seasons && printSeason(seasons[inputsProps[formNames.season].value]),
        })}
