            ...
            <div className="home-message rules-privacy-policy" style={{ width: '100%' }}>
              ...
              <section id="data-confidentiality">
                ...
                <p>
                  ...
                  données à une autre société pour n'importe quelle raison, sans votre consentement.
                </p>
              </section>
              <section id="data-protection">
                ...
                <p>
                  ...
                  ligne. Seuls les employés qui ont besoin d'effectuer un travail spécifique (par
                  exemple le service à l'utilisateur) ont accès aux informations personnelles
                  identifiables comme les emails. Les ordinateurs et serveurs utilisés pour stocker
              ...
              <section id="cookie-use">
                ...
                <p>
                  ...
                  réguliers. Cependant, cette utilisation des cookies n'est en aucune façon liée à
                  des informations personnelles identifiables sur notre site.
                </p>
              </section>
              <section id="email-use">
                ...
                <p>
                  ...
                  compte et pour vous permettre d'actualiser votre mot de passe, le cas échéant.
                </p>
              </section>
