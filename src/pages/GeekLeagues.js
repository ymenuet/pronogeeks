                    ...
                    <div className='my-geekleagues row'>
                        {geekLeagues.map(geekLeague => <div key={geekLeague._id} className='col-10 col-lg-6 geekleague-card-container'>
                            <div className='geekleague-card'>
                                ...
                                <h6>Créée par {geekLeague.creator.username} en {parseInt(new Date(geekLeague.createdAt).getMonth()) + 1 > 9 ? parseInt(new Date(geekLeague.createdAt).getMonth()) + 1 : `0${parseInt(new Date(geekLeague.createdAt).getMonth()) + 1}`}/{new Date(geekLeague.createdAt).getFullYear()}</h6>
