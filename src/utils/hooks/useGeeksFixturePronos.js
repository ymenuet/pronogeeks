...
import { handleStateWith2Ids } from '../helpers/stateHandlers';

import { getGeekleagueFixturePronos } from '../../state/actions/pronogeekActions';
...
export const useGeeksFixturePronos = (fixture, geekLeague) => {
  ...
  const geeksFixturePronogeeks = useSelector(
    ({ pronogeekReducer }) => pronogeekReducer.geeksFixturePronogeeks
  );
