      ...
      <ThemeProvider theme={themes[themeKey]}>
        <AppLayout>
          <Switch>
            ...
            <PrivateRoute
              component={Pronogeeks}
              exact
              path="/pronogeeks/:seasonID/matchweek/:matchweekNumber"
            />
            <PrivateRoute
              component={GeekMatchweek}
              exact
              path="/geek/:geekID/pronogeeks/:seasonID/matchweek/:matchweekNumber"
            />
            ...
            <PrivateRoute
              component={GeekLeagueMatchweek}
              exact
              path="/myGeekleagues/:geekLeagueID/season/:seasonID/:matchweekNumber"
            />
            <PrivateRoute
              component={GeekLeagueMatchweek}
              exact
              path="/myGeekleagues/:geekLeagueID/season/:seasonID"
            />
            <PrivateRoute
              component={SeasonRanking}
              exact
              path="/ranking/season/:seasonID/:matchweekNumber"
            />
